...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($title_err) && empty($sdescription_err) && empty($description_err) && empty($url_err) && empty($category_err)){
...
<div class="w-100 d-flex justify-content-center">
    <form class="w-50 my-3" action="" method="POST" novalidate>
        ...
        <div class="form-group mb-3">
            <select name="category" id="category" class="form-select form-select-lg <?= (!empty($category_err)) ? 'is-invalid' : '' ?>" aria-label="Large select example">
